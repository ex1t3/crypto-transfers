...
namespace Service.Services
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public async Task<bool> SendEmailAsync(string email, string subject, string message)
        {
            ...
            emailMessage.From.Add(new MailboxAddress("ISLB TRANSFERS", "tarasforskype@gmail.com"));
            ...
            {
                await client.ConnectAsync(SmtpSettings.Server, SmtpSettings.Port, SmtpSettings.IsSSL);
