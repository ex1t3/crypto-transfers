  ...
  <b-container class="islb-crypto-transfers--transaction-speeds">
    ...
    <b-row>
        ...
        <div class="speed-bar-item islb-speed">
            ...
            <h5 class="speed-bar-amount"><span id="speed-value-islb" data-value="100000">0</span>k</h5>
        </div>
        <div class="speed-bar-item visa-speed">
            <h4 class="speed-bar-title">VISA</h4>
            <h5 class="speed-bar-amount"><span id="speed-value-visa" data-value="24000">0</span>k</h5>
        </div>
        <div class="speed-bar-item ripple-speed">
            <h4 class="speed-bar-title">RIPPLE</h4>
            <h5 class="speed-bar-amount"><span id="speed-value-ripple" data-value="1500">0</span>k</h5>
        </div>
        <div class="speed-bar-item paypal-speed">
            <h4 class="speed-bar-title">PAYPAL</h4>
            <h5 class="speed-bar-amount"><span id="speed-value-paypal" data-value="193">0</span></h5>
        </div>
        <div class="speed-bar-item etherium-speed">
            <h4 class="speed-bar-title">ETHEREUM</h4>
            <h5 class="speed-bar-amount"><span id="speed-value-ethereum" data-value="20">0</span></h5>
        </div>
        </div>
...
export default {
    ...
    handleScroll (event) {
        if (!this.isScrolledToBlock) {
            if (this.isScrolledIntoView(document.getElementById('speed-bar-block'))) {
